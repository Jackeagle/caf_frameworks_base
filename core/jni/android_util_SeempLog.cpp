...
int __android_seemp_socket_write(const char *msg)
{
     struct iovec vec;
     vec.iov_base   = (void *) msg;
     vec.iov_len    = strlen(msg) + 1;
                                            ...
                                            jstring msgObj)
{
    ...
    res = __android_seemp_socket_write(msg);
...
static JNINativeMethod gMethods[] = {
    ...
    { "seemp_println_native",  "(Ljava/lang/String;)I", (void*) android_util_SeempLog_println_native },
};

 ...
 *
 * #############################################################################
 * ######     SNAPDRAGON_SDK_FOR_ANDROID REQUIRED CLASS FOR CAMERA FACE DETECTION
 * ######
 * ######     Remove file if not supporting Advanced Camera Face Detection
 * ######     Dependencies:
 ...
 */
public class QCFace extends android.hardware.Camera.Face implements
        QCCapabilitiesInterface {
    public QCFace() {
        super();
    }
    ...
    public Bundle getCapabilities() {
        ...
        capabilitiesBundle.putStringArrayList(
                QCCapabilitiesInterface.KEY_ACTIVE_METHOD_NAMES, methodList);

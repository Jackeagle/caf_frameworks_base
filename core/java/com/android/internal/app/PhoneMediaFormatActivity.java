 ...
 */
public class PhoneMediaFormatActivity extends AlertActivity implements DialogInterface.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        p.mTitle = getString(com.android.internal.R.string.phonemedia_format_title);
        p.mMessage = getString(com.android.internal.R.string.phonemedia_format_message);
        p.mPositiveButtonText = getString(com.android.internal.R.string.phonemedia_format_button_format);

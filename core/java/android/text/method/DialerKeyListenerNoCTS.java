 ...
 */
public class DialerKeyListenerNoCTS extends DialerKeyListener
{
    @Override
    ...
    public static DialerKeyListenerNoCTS getInstance() {
        if (sInstance != null)
            return sInstance;

        sInstance = new DialerKeyListenerNoCTS();
        return sInstance;
    }
    ...
    private static DialerKeyListenerNoCTS sInstance;
}

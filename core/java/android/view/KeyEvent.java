...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    /** Key code constant: Rotation Lock Button key.
     * Rotation lock dedicated button. */
    public static final int KEYCODE_BUTTON_ROTATION_LOCK     = 111;
    ...
    private static final int LAST_KEYCODE           = KEYCODE_BUTTON_ROTATION_LOCK;

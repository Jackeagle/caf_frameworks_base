...
import android.provider.RecentCallsPreferences;//xiaohong add 
...
public class CallLog {
    ...
    public static class Calls implements BaseColumns {
         ...
         * @hide
         */
        public static final int DURATION_TYPE_ACTIVE = 0;//xiaohong add

        /**
         * duration type for call out time.
         * @hide
         */
        public static final int DURATION_TYPE_CALLOUT = 1;//xiaohong add 
         ...
         * @hide
         */
        public static final String DURATION_TYPE = "duration_type";//xiaohong add 
         ...
         * <P>Type: INTEGER (long)</P>
         */
        public static final String CALLTYPE = "call_type";//xiaohong add 
         ...
         * @hide
         */
        public static final String SUBSCRIPTION = "sub_id"; //xiaohong add         
		 //xiaohong add 
		  /**
        ...
        public static String getLastOutgoingCall(Context context) {
            ...
            try {
                c = resolver.query(
                    CONTENT_URI,
                    new String[] {NUMBER},
                    TYPE + " = " + OUTGOING_TYPE + " OR " +//xiaohong modify 
                    TYPE + " = " + OUTGOING_CSVT_TYPE,//xiaohong modify
                    null,

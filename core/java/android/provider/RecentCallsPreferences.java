...
*/
    ...
    public RecentCallsPreferences(Context context) {
    	android.util.Log.i("lvxinyang", "context = " + (context!=null));
        mSharedPreferences = context.getSharedPreferences(PREFERENCES_NAME, Context.MODE_PRIVATE);
        android.util.Log.i("lvxinyang", "mSharedPreferences = " + (mSharedPreferences!=null));
        editor = mSharedPreferences.edit();
        android.util.Log.i("lvxinyang", "editor = " + (editor!=null));
	...
	public static synchronized RecentCallsPreferences getPreferences(Context context) {
		android.util.Log.i("lvxinyang", "preferences = " + (preferences!=null));
		if (preferences == null) {
		    preferences = new RecentCallsPreferences(context);
		}
		android.util.Log.i("lvxinyang", "end preferences = " + (preferences!=null));
		return preferences;
	}
	 
    public void setLong(String key, long value) {
    	android.util.Log.i("lvxinyang", "setLong key = " + key + " value = " + value);
        editor.putLong(key, value);
        editor.commit();
		android.util.Log.i("lvxinyang", "setLong key = " + getLong(key));	
    }
   
    public long getLong(String key) {
    	android.util.Log.i("lvxinyang", "getLong key = " + key);
    	android.util.Log.i("lvxinyang", "getLong key = " + mSharedPreferences.getLong(key, 0));

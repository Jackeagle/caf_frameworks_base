...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
        ...
        /**
         * Whether wifi settings will connect to access point automatically when network
         * from mobile network transform to Wifi network.
         * 0 = automatically
         * 1 = manually
         * 2 = always ask
         *
         * @hide
         */
        public static final String DATA_WIFI_CONNECT_TYPE = "data_wifi_connect_type";

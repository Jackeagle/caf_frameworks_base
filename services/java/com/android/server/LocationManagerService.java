...
public class LocationManagerService extends ILocationManager.Stub {
    ...
    private Location screenLocationLocked(Location location, String provider) {
        ...
        if (!extras.containsKey(mComboNlpPackageName + ".nlp:ready")) {
            ...
            if (records != null) {
                for (UpdateRecord r : records) {
                    if (r.mReceiver.mPackageName.equals(mComboNlpPackageName)) {
                        extras.putBoolean(mComboNlpPackageName + ".nlp:screen", true);
            ...
            extras.remove(mComboNlpPackageName + ".nlp:ready");
        }

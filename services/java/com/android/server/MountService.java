...
class MountService extends IMountService.Stub
    ...
    class VolumeState {
        ...
        public static final int NoSpace    = 9;
        public static final int Incompat   = 10;
    }
    ...
    private void handleSystemReady() {
        if(LOCAL_LOGD)Slog.d(TAG, "handleSystemReady");
        ...
        for (int i = count-1; i >=0; i--) {
            ...
            Slog.d(TAG, "handleSystemReady mount path="+path+" state="+state);
            ...
            public void run() {
                ...
                try {
                    ...
                    for (String volstr : vols) {
                        ...
                        Slog.i(TAG, "onDaemonConnected path="+path+" st ="+ Integer.parseInt(tok[2]));
    ...
    private void notifyVolumeStateChange(String label, String path, int oldState, int newState) {
        ...
        } else if (newState == VolumeState.NoSpace) {
           //update VolumeState to let StorageNotification kown,no intent to send
            updatePublicVolumeState(volume, Environment.MEDIA_NO_SPACE);
    ...
    private ArrayList<String> getShareableVolumes() {
        ...
        synchronized (mVolumes) {
            for (StorageVolume v : mVolumes) {
                Slog.d(TAG,"getShareableVolumes vpath="+v.getPath()+" allow="+v.allowMassStorage());
    ...
    public void setUsbMassStorageEnabled(boolean enable) {
        ...
        for (String path : getShareableVolumes()) {
            ...
            String method = "ums";
/*skip the MEDIA_MOUNTED judgement because if wrong formatted, it'll Mounted faiurelly , leading to disappear in PC side when UMS.*/ 
//            if (enable && vs.equals(Environment.MEDIA_MOUNTED)) {
    ...
    public String getVolumeState(String mountPoint) {
        if(LOCAL_LOGD)Log.w(TAG, "getVolumeState(" + mountPoint + ")  ");
        synchronized (mVolumesLock) {

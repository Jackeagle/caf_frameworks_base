...
public class IpServer extends StateMachine {
    ...
    private boolean configureIPv4(boolean enabled) {
        ...
        } else if (mInterfaceType == ConnectivityManager.TETHERING_P2P) {
            ipAsString = P2P_HOST_IFACE_ADDR;
            prefixLen = P2P_HOST_IFACE_PREFIX_LENGTH;
        } else {
        ...
        try {
            ...
            if (mInterfaceType == ConnectivityManager.TETHERING_WIFI
                  || mInterfaceType == ConnectivityManager.TETHERING_P2P) {

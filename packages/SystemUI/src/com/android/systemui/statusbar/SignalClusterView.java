...
public class SignalClusterView
    ...
    View mNoSimsCombo;
    ImageView mVpn, mEthernet, mWifi, mAirplane,mNoSims, mEthernetDark,
                mWifiDark, mNoSimsDark, mImsOverWifiImageView, mMobileImsImageView;
    ...
    public void setMobileDataIndicators(IconState statusIcon, IconState qsIcon, int statusType,
            ...
            int mobileActivityId, int stackedDataId, int stackedVoiceId,
            String typeContentDescription, String description, boolean isWide, int subId,
            boolean isMobileIms, boolean isImsOverWifi, int dataNetworkTypeId,
            int embmsIconId) {
        PhoneState state = getState(subId);
        if (state == null) {
            return;
    ...
    private class PhoneState {
        ...
        private int mDataActivityId = 0, mMobileActivityId = 0,
                 mDataNetworkTypeId =0, mMobileEmbmsId = 0;

...
public class TelephonyIcons {
    ...
    public static final int[][] CMCC_DATA_SIGNAL_STRENGTH_G
    = TELEPHONY_CMCC_SIGNAL_STRENGTH_G;
    public static final int[][] CMCC_DATA_SIGNAL_STRENGTH_R_G
    = TELEPHONY_CMCC_SIGNAL_STRENGTH_ROAMING_G;
    public static final int[][] CMCC_DATA_SIGNAL_STRENGTH_E
    = TELEPHONY_CMCC_SIGNAL_STRENGTH_E;
    public static final int[][] CMCC_DATA_SIGNAL_STRENGTH_R_E
    = TELEPHONY_CMCC_SIGNAL_STRENGTH_ROAMING_E;
    public static final int[][] CMCC_DATA_SIGNAL_STRENGTH_3G
    = TELEPHONY_CMCC_SIGNAL_STRENGTH_3G;
    public static final int[][] CMCC_DATA_SIGNAL_STRENGTH_R_3G
    = TELEPHONY_CMCC_SIGNAL_STRENGTH_ROAMING_3G;
    public static final int[][] CMCC_DATA_SIGNAL_STRENGTH_4G
    = TELEPHONY_CMCC_SIGNAL_STRENGTH_4G;
    public static final int[][] CMCC_DATA_SIGNAL_STRENGTH_R_4G
    = TELEPHONY_CMCC_SIGNAL_STRENGTH_ROAMING_4G;

...
public class PhoneStatusBar extends BaseStatusBar {
    ...
    protected PhoneStatusBarView makeStatusBarView() {
        ...
        if (MSimTelephonyManager.getDefault().isMultiSimEnabled()) {
            ...
            SignalClusterView signalCluster = null;
            switch (STATUSBAR_STYLE){
                case STATUSBAR_STYLE_CMCC:
                    signalCluster = (CMCCSignalClusterView)View.inflate(context, R.layout.signal_cluster_view_cmcc, null);
                    LinearLayout signalView = (LinearLayout)mStatusBarView.findViewById(R.id.signal_cluster);
                    signalView.removeAllViews();
                    signalView.setId(R.id.signal_cluster);

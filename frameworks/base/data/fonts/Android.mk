...
LOCAL_SRC_FILES := ../../../../vendor/qcom/proprietary/qrdplus/globalization/engine/DroidSansTamil.ttf
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_PATH := $(TARGET_OUT)/fonts
include $(BUILD_PREBUILT)
...
LOCAL_SRC_FILES := ../../../../vendor/qcom/proprietary/qrdplus/globalization/engine/DroidSansHindi.ttf
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_PATH := $(TARGET_OUT)/fonts
include $(BUILD_PREBUILT)
...
LOCAL_SRC_FILES := ../../../../vendor/qcom/proprietary/qrdplus/globalization/engine/DroidSansTelugu.ttf
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_PATH := $(TARGET_OUT)/fonts
include $(BUILD_PREBUILT)
...
LOCAL_SRC_FILES := ../../../../vendor/qcom/proprietary/qrdplus/globalization/engine/DroidSansPunjabi.ttf
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_PATH := $(TARGET_OUT)/fonts
include $(BUILD_PREBUILT)
...
LOCAL_SRC_FILES := ../../../../vendor/qcom/proprietary/qrdplus/globalization/engine/DroidSansGujarati.ttf
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_PATH := $(TARGET_OUT)/fonts
include $(BUILD_PREBUILT)
...
LOCAL_SRC_FILES := ../../../../vendor/qcom/proprietary/qrdplus/globalization/engine/DroidSansBengali.ttf
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_PATH := $(TARGET_OUT)/fonts
include $(BUILD_PREBUILT)
...
include $(CLEAR_VARS)
LOCAL_MODULE := DroidSansMalayalam.ttf
LOCAL_SRC_FILES := ../../../../vendor/qcom/proprietary/qrdplus/globalization/engine/DroidSansMalayalam.ttf
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_PATH := $(TARGET_OUT)/fonts
include $(BUILD_PREBUILT)
...
LOCAL_SRC_FILES := ../../../../vendor/qcom/proprietary/qrdplus/globalization/engine/DroidSansKannada.ttf
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_PATH := $(TARGET_OUT)/fonts
include $(BUILD_PREBUILT)

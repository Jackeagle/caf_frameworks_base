...
#define USER_BOOTANIMATION_FILE "/data/qrd_theme/boot/bootanimation.zip"
#define SYSTEM_BOOTANIMATION_FILE "/system/media/bootanimation.zip"
#define SYSTEM_ENCRYPTED_BOOTANIMATION_FILE "/system/media/bootanimation-encrypted.zip"

#define USER_SHUTDOWN_ANIMATION_FILE "/data/qrd_theme/boot/shutdownanimation.zip"
...
#define USER_BOOT_MUSIC_FILE "/data/qrd_theme/boot/boot.wav"
#define SYSTEM_BOOT_MUSIC_FILE "/system/media/boot.wav"

#define USER_SHUTDOWN_MUSIC_FILE "/data/qrd_theme/boot/shutdown.wav"

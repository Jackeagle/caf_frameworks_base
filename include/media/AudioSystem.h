...
public:
    ...
    enum audio_devices {
        ...
        DEVICE_OUT_ALL = (DEVICE_OUT_EARPIECE | DEVICE_OUT_SPEAKER | DEVICE_OUT_WIRED_HEADSET |
                ...
                DEVICE_OUT_BLUETOOTH_A2DP_SPEAKER | DEVICE_OUT_AUX_DIGITAL | DEVICE_OUT_AUX_HDMI | DEVICE_OUT_FM | DEVICE_OUT_DIRECTOUTPUT |
                DEVICE_OUT_ANC_HEADSET | DEVICE_OUT_ANC_HEADPHONE | DEVICE_OUT_FM_TX | DEVICE_OUT_DEFAULT),

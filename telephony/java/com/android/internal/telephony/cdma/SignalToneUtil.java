...
public class SignalToneUtil {
    ...
    static {
        ...
        hm.put(signalParamHash(IS95_CONST_IR_SIGNAL_TONE, IS95_CONST_IR_ALERT_LOW,
                IS95_CONST_IR_SIG_TONE_DIAL), ToneGenerator.TONE_CDMA_DIAL_TONE_LITE);

        hm.put(signalParamHash(IS95_CONST_IR_SIGNAL_TONE, IS95_CONST_IR_ALERT_MED,
                IS95_CONST_IR_SIG_TONE_DIAL), ToneGenerator.TONE_CDMA_DIAL_TONE_LITE);

        hm.put(signalParamHash(IS95_CONST_IR_SIGNAL_TONE, IS95_CONST_IR_ALERT_HIGH,
                IS95_CONST_IR_SIG_TONE_DIAL), ToneGenerator.TONE_CDMA_DIAL_TONE_LITE);

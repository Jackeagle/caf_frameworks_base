...
*/
    ...
    private void processUnsolOemhookResponse(ByteBuffer oemHookResponse) {
        ...
        final int QCRILHOOK_UNSOL_LOCAL_RINGBACK_START = QCRILHOOK_BASE + 1004;
        final int QCRILHOOK_UNSOL_LOCAL_RINGBACK_STOP = QCRILHOOK_BASE + 1005;
        ...
        switch (response_id) {
            case QCRILHOOK_UNSOL_LOCAL_RINGBACK_START:
                notifyLocalRingbackTone(true);
                break;

            case QCRILHOOK_UNSOL_LOCAL_RINGBACK_STOP:
                notifyLocalRingbackTone(false);
                break;
    ...
    /** Notify registrants of a Local Ringback Tone. */
    protected void notifyLocalRingbackTone(boolean enable) {
        AsyncResult ar = new AsyncResult(null, enable, null);
        mLocalRingbackToneRegistrants.notifyRegistrants(ar);
    }

...
public interface CommandsInterface {
    ...
    enum IccStatus {
        ...
        ICC_CARD_IO_ERROR,
        ICC_NETWORK_SUBSET_PERSONALIZATION,
        ICC_CORPORATE_PERSONALIZATION,
        ICC_SERVICE_PROVIDER_PERSONALIZATION,
        ICC_SIM_PERSONALIZATION,
        ICC_RUIM_NETWORK1_PERSONALIZATION,
        ICC_RUIM_NETWORK2_PERSONALIZATION,
        ICC_RUIM_HRPD_PERSONALIZATION,
        ICC_RUIM_CORPORATE_PERSONALIZATION,
        ICC_RUIM_SERVICE_PROVIDER_PERSONALIZATION,
        ICC_RUIM_RUIM_PERSONALIZATION,
        ICC_PERSONALIZATION_NOT_SUPPORTED
    }

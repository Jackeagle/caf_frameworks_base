...
public class IccSmsInterfaceManager extends ISms.Stub {
    ...
    public SmsUsageMonitor mUsageMonitor;
    ...
    protected IccSmsInterfaceManager(PhoneBase phone){
        ...
        mStorageMonitor = new SmsStorageMonitor(phone);
        mUsageMonitor = new SmsUsageMonitor(phone.getContext().getContentResolver());

        mDispatcher = new ImsSMSDispatcher(phone, mStorageMonitor, mUsageMonitor);
    ...
    public void dispose() {
        ...
        mStorageMonitor.dispose();
        mUsageMonitor.dispose();
    }

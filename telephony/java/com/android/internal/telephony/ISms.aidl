...
interface ISms {
     ...
     *  raw pdu of the status report is in the extended data ("pdu").
     */
    void sendDataWithOrgPort(String callingPkg, in String destAddr, in String scAddr,
        in int destPort, in int orgPort, in byte[] data, in PendingIntent sentIntent,
